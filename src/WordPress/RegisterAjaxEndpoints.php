<?php
    ...
    class RegisterAjaxEndpoints
    {
        ...
        {
            add_action('wp_ajax_insert_sales_api_token', 'insert_sales_api_token');
            add_action('wp_ajax_nopriv_insert_sales_api_token', 'insert_sales_api_token');
            add_action('wp_ajax_check_if_sales_api_token_exists', 'check_if_sales_api_token_exists');
            add_action('wp_ajax_nopriv_check_if_sales_api_token_exists', 'check_if_sales_api_token_exists');
    
            function insert_sales_api_token()
            {
                global $wpdb;
            ...
            function check_if_sales_api_token_exists()
            {
                global $wpdb;
